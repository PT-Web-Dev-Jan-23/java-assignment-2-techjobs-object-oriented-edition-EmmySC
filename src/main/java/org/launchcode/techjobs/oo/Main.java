...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Job job3 = new Job("Ice cream tester", new Employer(""),
                new Location("Home"), new PositionType("UX"),
                new CoreCompetency("Tasting ability"));
        //Job job4 = new Job("Teacher", new Employer("St. Louis Chess Club"), new Location("CWE"),
        // new PositionType("Chess Coach"), new CoreCompetency("Instruction"));
